...
using ng2_admin.C_.Middleware.Model.Logout;
using IdentityModel;
using IdentityServer4;

namespace ng2_admin.C_.Middleware.Services.Account
{
    public class ModelService
    {
        ...
        public async Task<LogoutViewModel> BuildLogoutViewModelAsync(string logoutId, HttpContext httpContext)
        {
        ...
        public async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId, HttpContext httpContext)
        {
